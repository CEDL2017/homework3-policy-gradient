...
class CategoricalPolicy(object):
    def __init__(self, in_dim, out_dim, hidden_dim, optimizer, session):
        ...
        2. Currentlyr, variable `self._advantages` epresents accumulated discounted rewards
            from each timestep to the end of an episode
        3. Compute surrogate loss and ass it toign variable `surr_loss` (Note that the tf.optimizer 
